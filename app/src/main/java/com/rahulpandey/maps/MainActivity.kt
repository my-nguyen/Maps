...
import com.rahulpandey.maps.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.recycler.adapter = MapsAdapter(userMaps, object: MapsAdapter.OnClickListener {
            override fun onItemClick(position: Int) {
                Log.d(TAG, "onItemClick at $position")

                // when user clicks on an item in the RecyclerView, navigate to a new Activity
